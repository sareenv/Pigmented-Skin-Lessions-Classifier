...
Furthermore, data science and machine learning libraries are required such as Numpy, Keras, Matplotlib and OpenCV. Numpy library is required for performing mathematical operations on multi-dimensional NumPy arrays. Matplotlib library provides an interface to visualise the output results. 
